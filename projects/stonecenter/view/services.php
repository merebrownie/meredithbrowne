...
<body>
    <div id="wrap">
        ...
        <div class="services">
            ...
            <div class="links">
                <ul>
                    <li><a href="#individual" id="individualLink">Individual</a></li>
                    <li><a href="#couples" id="couplesLink">Couples</a></li>
                    <li><a href="#teen" id="teenLink">Teens</a></li>
                    <li><a href="#play" id="playLink">Children</a></li>
                    <li><a href="#family" id="familyLink">Family</a></li>
                    <li><a href="#coaching" id="coachingLink">Parent Coaching</a></li>
                </ul>
            </div>
            <div id="individual" class="tab">
                ...
                can lead to greater self-awareness, insight and strength to face the challenges of life and to find joy and meaning.
                </p>
                <p class="quote">
                "To the question of your life you are the answer, and to the problems of your life you are the solution." ~Joe Cordare
                </p>
                <p>For more information: <span class="popupLink">Contact Us</span></p>
            </div>
            ...
            <div id="couples" class="tab">
                ...
                equips you to face the stresses of life than the support and strength that comes from a healthy, full marriage.
                </p>
                <p class="quote">    
            ...
            <div id="play" class="tab">
                ...
                <p class="quote">Kids spell love T-I-M-E. ~John Crudele</p>
                <p>For more information: <span class="popupLink">Contact Us</span></p>
            </div>
            ...
            <div id="coaching" class="tab">
                ...
                <li>Are you finding it difficult to find effective discipline methods?</li>
                <li>Do you just need some support and guidance in gaining confidence in your parenting?</li>
                ...
                Learn effective discipline methods that teach responsibility and decrease power struggles. Every family is different, has different challenges, values and priorities. Your coaching session(s) are tailored to your family and to meet your specific needs and goals.

                Coaching begins with a meeting to discuss and gain an understanding of your current challenges and goals. A parenting plan will be developed and the number of sessions will be based on your particular goals. 
                </p>
                <p>For more information: <span class="popupLink">Contact Us</span></p>
            </div>
                <br><br><br><span id="validate"><a href="http://validator.w3.org/check?uri=referer">Validate HTML</a>
                <a href="http://jigsaw.w3.org/css-validator/check/referer">Validate CSS</a></span>

        </div>
        <div id="popUp" class="services">
            <h3>Questions or Comments?</h3>
            <form name = "commentForm" class = "popupForm">
